package bsu.rfe.java.group7.lab4.CAI.varA7;
...
public class GraphicsDisplay extends JPanel {
    ...
    public GraphicsDisplay() {
        ...
        graphicsStroke = new BasicStroke(2.0f,
                ...
                10.0f,
                new float[] {4, 1, 4, 1, 4, 1, 1, 1, 1},
                0.0f);
        // Перо для рисования целой части графика
        graphicsIntStroke = new BasicStroke(3.0f,
                BasicStroke.CAP_BUTT,
                BasicStroke.JOIN_ROUND,
                10.0f,
                null,
    ...
    public void paintComponent(Graphics g) {
        ...
        if (scale == scaleX) {
            // Если за основу был взят масштаб по оси X, значит по оси Y делений меньше, т.е. подлежащий визуализации
            // диапазон по Y будет меньше высоты окна. Значит необходимо добавить делений, сделаем это так:
    ...
    protected void paintMarkers(Graphics2D canvas) {
        ...
        // Выбрать чёрный цвета для контуров маркеров
        canvas.setColor(Color.BLACK);
        // Выбрать чёрный цвет для закрашивания маркеров внутри
...
//            boolean temp = true;
    ...
    // Метод-помощник, осуществляющий преобразование координат. Он необходим, т.к. верхнему левому углу холста
    // с координатами (0.0, 0.0) соответствует точка графика с координатами (minX, maxY), где
    // minX - это самое "левое" значение X, а maxY - самое "верхнее" значение Y.
    ...
    // Метод-помощник, возвращающий экземпляр класса Point2D.Double смещённый по отношению к исходному на deltaX, deltaY
